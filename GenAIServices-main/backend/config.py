...
DATABASE_METHOD = os.environ.get("DATABASE_METHOD")
SQL_DATABASE_NAME = os.environ.get("SQL_DATABASE_NAME")

#PGVector Database
VECTOR_DATABASE_STORE = os.environ.get("VECTOR_DATABASE_STORE")
VECTOR_DATABASE_METHOD = os.environ.get("VECTOR_DATABASE_METHOD")
VECTOR_DATABASE_NAME = os.environ.get("VECTOR_DATABASE_NAME")
